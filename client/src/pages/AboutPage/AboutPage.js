...
import aboutImage from '../../images/about-bg.jpg'
...
function AboutPage() {
  return (
    <div className='aboutPageContainer'>
      <Slide title="About Me" subtitle="This is what I do." image={aboutImage} />
      <Box className='contentContainer'>
        <Typography variant="body1" className='contentParagraph'>
